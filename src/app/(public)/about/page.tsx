...
export const metadata = {
  title: 'About Us — FORMIQ 3D Print Studio',
  description: 'Learn about FORMIQ — India\'s premium 3D printing studio offering FDM, SLA, SLS, DMLS and more from Ahmedabad.',
};
    ...
    <div style={{ backgroundColor: '#1A1A1A' }}>
      ...
      <section className="relative overflow-hidden py-24 sm:py-32">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in">
          ...
          <h1 className="page-heading text-4xl sm:text-5xl mb-6" style={{ color: '#F5F4F0' }}>
            About <span style={{ color: '#C9920A' }}>FORMIQ</span>
          </h1>
          <div className="gold-rule w-16 mx-auto mb-8" />
          <p className="tagline text-xl mb-6" style={{ color: '#C9920A' }}>
            &ldquo;Layer by layer. Smarter by design.&rdquo;
          </p>
          <p className="text-base leading-relaxed max-w-2xl mx-auto" style={{ color: '#9CA3AF' }}>
            FORMIQ is a premium 3D printing studio based in Ahmedabad, Gujarat. We combine industrial-grade
      ...
      <section className="py-20 sm:py-24" style={{ backgroundColor: 'rgba(27,42,74,0.15)' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="page-heading text-3xl mb-4" style={{ color: '#F5F4F0' }}>Our Story</h2>
              <div className="gold-rule w-12 mb-6" />
              <div className="space-y-4 text-base leading-relaxed" style={{ color: '#9CA3AF' }}>
                <p>
                  FORMIQ was born from a single frustration: getting high-quality 3D prints in India meant weeks
                ...
                <p>
                  Today, FORMIQ serves engineers, product designers, architects, educators, and hobbyists across
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={s.label} className="rounded-xl p-6 text-center card-hover" style={{ backgroundColor: '#1B2A4A', border: '1px solid rgba(201,146,10,0.15)' }}>
                  <p className="text-3xl font-light mb-1" style={{ color: '#C9920A' }}>{s.value}</p>
      ...
      <section className="py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="page-heading text-3xl sm:text-4xl mb-4" style={{ color: '#F5F4F0' }}>What We Stand For</h2>
            <div className="gold-rule w-16 mx-auto mb-3" />
            <p style={{ color: '#6B6B6B' }}>The principles behind every print we make.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((v) => (
              <div key={v.title} className="rounded-xl p-6 card-hover group" style={{ backgroundColor: '#1B2A4A', border: '1px solid rgba(201,146,10,0.12)' }}>
                <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-4" style={{ border: '1px solid rgba(201,146,10,0.3)', color: '#C9920A' }}>
                  {v.icon}
                </div>
                <h3 className="text-sm font-medium mb-2" style={{ color: '#F5F4F0', letterSpacing: '0.04em' }}>{v.title}</h3>
      ...
      <section className="py-20 sm:py-24" style={{ backgroundColor: 'rgba(27,42,74,0.15)' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="page-heading text-3xl sm:text-4xl mb-4" style={{ color: '#F5F4F0' }}>The Team</h2>
          <div className="gold-rule w-16 mx-auto mb-3" />
          <p className="mb-12" style={{ color: '#6B6B6B' }}>Small team. Big output. Relentless quality.</p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {team.map((t) => (
              <div key={t.name} className="rounded-xl p-8 card-hover" style={{ backgroundColor: '#1B2A4A', border: '1px solid rgba(201,146,10,0.12)' }}>
                <div className="w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-4 text-xl font-light" style={{ backgroundColor: 'rgba(201,146,10,0.12)', color: '#C9920A', border: '1px solid rgba(201,146,10,0.25)' }}>
                  {t.initials}
                </div>
                <p className="font-medium" style={{ color: '#F5F4F0' }}>{t.name}</p>
      ...
      <section className="py-20">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <div className="rounded-xl p-10" style={{ backgroundColor: '#1B2A4A', border: '1px solid rgba(201,146,10,0.2)' }}>
            <h2 className="page-heading text-2xl sm:text-3xl mb-4" style={{ color: '#F5F4F0' }}>Ready to Print?</h2>
            <p className="mb-8" style={{ color: '#9CA3AF' }}>
              Join engineers and designers across India who trust FORMIQ for their 3D printing needs.
            </p>
            <Link
              href="/signup"
